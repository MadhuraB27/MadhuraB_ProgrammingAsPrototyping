...
function setup() {
    ...
    // color picker
    let colorPicker = createColorPicker(brushColor); // default color
    ...
    function setup() {
        ...
        //custom CSS class to the slider
    ...
    let eraserImgElement = createImg('images/eraser.png'); 
   
    eraserImgElement.id('eraser-icon');

    eraserImgElement.parent(eraserButton); 
